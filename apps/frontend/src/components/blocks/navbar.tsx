    ...
    dropdownItems: [
      {
        ...
        description:
          "Encrypted swaps protect your trades from MEV bots and front-runners",
      },
      {
        title: "LP Privacy",
        href: "/#lp-privacy",
        description: "Hidden liquidity positions for institutional-grade privacy",
      },
    ],
  },
    ...
    >
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <a
            href="https://github.com/kunalsinghdadhwal/azoth-protocol"
